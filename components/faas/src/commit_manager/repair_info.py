class RepairInfo:
    ...
    def add_upstream_func_key(self, batch_id, downstream_workflow_name, upstream_tx_id, downstream_tx_id, upstream_func, downstream_func, upstream_ip, downstream_ip):
        ...
        if downstream_func not in downstream_func_dict:
            downstream_func_dict[downstream_func] = True
            upstream_func_successor.append({"transaction_id": downstream_tx_id, "workflow_name": downstream_workflow_name, "function_name": downstream_func, "ip": downstream_ip})
    ...
    def update_crosstx_subjection_table(self, batch_id, downstream_workflow_name, upstream_tx_id,  downstream_tx_id, upstream_func, downstream_func, upstream_ip, downstream_ip, key):
        ...
        self.add_upstream_func_key(batch_id, downstream_workflow_name, upstream_tx_id, downstream_tx_id, upstream_func,downstream_func, upstream_ip, downstream_ip)
    ...
    def update_introtx_RYW_subjection_table(self, batch_id, ip, tx_id, write_func, RYW_subjection):
        ...
        func_dict[ip][tx_id][write_func]['RYW'] = RYW_subjection
    ...
    def target_function_dirty(self, batch_id, ip, tx_id, func):
        ...
        func_dict[ip][tx_id][func]['dirty'] = True
