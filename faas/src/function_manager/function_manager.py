...
class FunctionManager:
    def __init__(self, host_addr, config_path, min_port, node_list, reserve_pool, function_pos):
        ...
        for x in self.function_info:
            ...
            self.functions[x.function_name] = Function(host_addr, self.client, x, self.port_controller, node_list, self.default_container_num, reserve_pool, graph_info['input'], graph_info['output'], self.function_pos)
        self.init()
