...
class Container:
    ...
    def init(self, workflow_name, function_name, transaction_sink_addr,validator_addr, node_list, input,output, function_pos, port, fast_path_enabled=False, optimistic_repair=False):
