...
def main():
    ...
    combined_content = []
    combined_content.append(func_input["t9"])
    combined_content.append(store.get("t8"))
    combined_content.append(store.get("t10"))
    ...
    store.put('t10', shuffled_content[0 : part_size])
    store.ret({"t11":shuffled_content[part_size:2*part_size]})