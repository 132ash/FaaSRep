...
def analyze_workflow(workflow, parameters_input):
    ...
    return transaction_id, {
        "success_exec_latency": rep.get('success_exec_latency', 0),
...
def analyze_all_workflows(system_mode):
    ...
    for workflow, results_list, total_time in raw_workflow_results:
        ...
        success_exec_latency = df['success_exec_latency'].mean()
        whole_exec_latency = df['workflow_exec_latency'].mean()
        ...
        summary_dict = {
            ...
            'avg_success_exec_latency': success_exec_latency,
            'avg_whole_exec_latency': whole_exec_latency,
