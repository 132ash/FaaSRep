...
- `result/`: raw per-segment execution output, merged summaries, figures, notes, and result analysis scripts.
...
- RPM inputs: `prepare/rpm/highload.csv`.
- Segment outputs: `prepare/segments/lowload/` and `prepare/segments/highload/`.
- Trace feature scripts and plots: `prepare/scripts/feature_analysis/`.
