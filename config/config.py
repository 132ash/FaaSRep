...
REDIS_PORT = 1145 # it follows the same configuration as created redis by docker (e.g., -p 6379:6379)
SHADOWTABLE_DB = 0
CACHE_DB = 1
...
# Function-level latency breakdown collection.
# Keep this disabled for trace throughput/latency experiments; enabling it records
# lock/exec/io timings asynchronously into CouchDB workflow_latency.
